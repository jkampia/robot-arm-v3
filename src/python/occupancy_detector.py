...
class ImageProcessor:
    ...
    def downscaleForDisplay(self, img, max_width=1280, max_height=720):
        """
    ...
    def transformCornersToDisplay(self, boardCornersFull, scaleFactor):
        """
    ...
    def computeCornerAnglesDegrees(self, corners):
        """
    ...
    def findLargestQuadrilateral(self, bgr, minAreaFraction=0.05, angleToleranceDeg=25):
        """
        ...
        for cnt in cnts:
            ...
            corners = self.orderCorners(quad)  # your existing TL,TR,BR,BL ordering

            # Rectangle-ness check: angles near 90
            angles = self.computeCornerAnglesDegrees(corners)
    ...
    def drawBoardEdges(self, image, boardCorners, lineThickness=4, drawLabels=True):
        """
    ...
    def rectifyBoard(self, image, boardCorners, outputWidth=800, outputHeight=800):
        """
    ...
    def sliceRectifiedBoardIntoCells(self, rectifiedImage, drawGrid=True, lineThickness=2):
        """
    ...
    def rectifiedRoiPipeline(self, originalFrame):
        ...
        rectifiedFrame, cellRois, cellRects = self.sliceRectifiedBoardIntoCells(rectifiedFrame, drawGrid=False)
        return cellRois
    ...
    def saveRoisToDirectoryJPG(self, cellRois, outputDir, jpegQuality=95, prefix="cell"):
        ...
        for idx, roi in enumerate(cellRois):
            ...
            filename = f"{prefix}_r{row}_c{col}.jpg"
